...
const brandBenefits = [
  { icon: Users, title: "Quality Candidates", description: "Pre-vetted talent from trusted referrers who stake their reputation." },
  { icon: TrendingUp, title: "Higher Retention", description: "Referred hires stay 2x longer and perform better from day one." },
  { icon: Clock, title: "Faster Hiring", description: "Cut time-to-hire by 50% with warm introductions from your network." },
  { icon: Shield, title: "Risk-Free", description: "Pay only when a referral leads to a successful hire. No upfront costs." },
  { icon: Building2, title: "Employer Branding", description: "Strengthen your employer brand through authentic word-of-mouth." },
  { icon: Zap, title: "Instant Access", description: "Tap into a network of 10,000+ active referrers across industries." },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <style>{`
        ...
        /* Two-Step Navigation styles are now in index.css */
      `}</style>
      <SiteFooter />
    </div>
  );
