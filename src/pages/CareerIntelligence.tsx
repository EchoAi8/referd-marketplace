...
const CareerIntelligence = () => {
  ...
  return (
    <>
      <GridOverlay key="career-intelligence-grid" />
      <CursorFollower />
      <PageTransition>
              ...
              <section className="relative min-h-[60vh] flex items-center justify-center px-4 pt-32 pb-16">
                <div className="text-center max-w-4xl mx-auto">
                  ...
                  >
                    ...
                    />
                    <span className="text-sage text-sm font-mono">ML-POWERED ANALYSIS</span>
                  </motion.span>
                  ...
                  >
                    Discover your true market value with real-time salary benchmarking powered by machine learning analysis of 500K+ data points.
                  </motion.p>
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold leading-[0.95] tracking-tight max-w-[10em] mx-auto">
                    Real-Time
                    <span className="text-sage"> Insights</span>
                  </h2>
                  <p className="mt-4 text-background/60 text-lg max-w-xl mx-auto">
                    Watch your market position update in real-time
                  </p>
                </div>
              ...
              <section className="relative flex flex-col items-center justify-center min-h-screen bg-background text-foreground px-4">
                ...
                <div className="text-center max-w-4xl">
                  ...
                  <div className="flex flex-wrap justify-center gap-8 mb-10">
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-2 mb-1">
                        <LineChart className="w-5 h-5 text-mustard" />
