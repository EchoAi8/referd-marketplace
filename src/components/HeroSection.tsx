    ...
    <section className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center px-6 py-20">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          ...
          className="font-heading text-xl md:text-2xl text-gray-600 mb-4"
        >
        ...
        <motion.p
          ...
          className="font-heading text-lg text-gray-500 mb-12 max-w-2xl mx-auto"
        >
        ...
        >
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">People earning</div>
          </div>
          <div>
        ...
        <motion.div
          ...
          className="mt-16 p-8 bg-gray-50 rounded-2xl max-w-xl mx-auto"
        >
          ...
          <p className="text-sm text-gray-500 mt-4">Everyone wins</p>
        </motion.div>
      </div>
    </section>
  );
