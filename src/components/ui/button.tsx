  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        mustard: "bg-mustard text-forest font-semibold rounded-cta hover:scale-105 shadow-soft hover:shadow-card",
        rose: "bg-rose text-forest font-semibold rounded-cta hover:scale-105 shadow-soft hover:shadow-card",
        nav: "text-forest font-medium hover:text-forest/70 bg-transparent",
      },
      size: {
        ...
        icon: "h-10 w-10",
        cta: "h-auto py-4 px-8 text-base",
      },
    },
    defaultVariants: {
      variant: "default",
